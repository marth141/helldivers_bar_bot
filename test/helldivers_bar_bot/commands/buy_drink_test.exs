defmodule HelldiversBarBot.Commands.BuyDrinkTest do
  use ExUnit.Case
  use HelldiversBarBot.DataCase
  use Mimic

  alias HelldiversBarBot.Commands.BuyDrink
  ...
  describe "add/0" do
    test "successfully adds command to discord bot" do
      ...
      expect(Nostrum.Api, :create_global_application_command, fn outgoing_application_id,
        ...
        assert command.name == "buy_drink"
        assert command.description == "buys a drink"
      ...
      assert {:ok, api_response} = BuyDrink.add()
