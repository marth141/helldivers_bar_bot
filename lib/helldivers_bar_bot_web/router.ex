defmodule HelldiversBarBotWeb.Router do
  use HelldiversBarBotWeb, :router

  import HelldiversBarBotWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {HelldiversBarBotWeb.Layouts, :root}
  ...
  # scope "/api", HelldiversBarBotWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:helldivers_bar_bot, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: HelldiversBarBotWeb.Telemetry
  ...
  scope "/", HelldiversBarBotWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{HelldiversBarBotWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", HelldiversBarBotWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{HelldiversBarBotWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", HelldiversBarBotWeb do
    ...
    live_session :current_user,
      on_mount: [{HelldiversBarBotWeb.UserAuth, :mount_current_user}] do
